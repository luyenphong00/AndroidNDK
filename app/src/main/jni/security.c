...
void Java_com_example_androidndk_MainActivity_helloLog(JNIEnv *env, jobject this, jstring logThis) {
    jboolean isCopy;
...
Java_com_example_androidndk_MainActivity_getStringHello(JNIEnv *env, jobject instance) {
